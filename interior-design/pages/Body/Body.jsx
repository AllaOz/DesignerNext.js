        ...
        <>
            <div className={styles.twoContainer}>
                <div className={styles.leftContainer}>
                    ...
                    <p className={styles.paragraphAboutme}>Interior Design Studio in Dubai. Designing spaces where style meets sustainability, making every design a masterpiece.</p>
